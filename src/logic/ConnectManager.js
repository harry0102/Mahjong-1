...
var ConnectManager = cc.Class.extend({
    ...
    connect: function () {
        ...
        this.websocket = new ReconnectingWebSocket(Game.server, null, {debug: true, reconnectInterval: 3000});
    ...
    onMessage: function (evt) {
        cc.log(evt);
        var data = JSON.parse(evt.getUserData().data);
        ...
        this._msgs[data.responseId] = data;
    },
