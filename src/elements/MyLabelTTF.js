 ...
 */
var MyLabelTTF = cc.LabelTTF.extend({
    canMove: false,
    /**
     * @param parent 父节点
     * @param fileName 图片名称
     ...
     * */
    ctor: function (parent, text, fontName, fontSize, callback, callbackTarget, dimensions, hAlignment, vAlignment) {

        this._super(text, fontName, fontSize, dimensions, hAlignment || cc.TEXT_ALIGNMENT_LEFT, vAlignment || cc.VERTICAL_TEXT_ALIGNMENT_CENTER);
        this.p = parent;
        this.width=60;
        this.height=60;
