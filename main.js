...
cc.game.onStart = function(){
    ...
    cc.loader.load(g_resources,function () {
        ...
        // cc.spriteFrameCache.addSpriteFrames(res.prepare_plist,res.prepare_png);
        cc.spriteFrameCache.addSpriteFrames(res.scene_plist,res.scene_png);

        cc.spriteFrameCache.addSpriteFrames(res.bao_plist,res.bao_png);
        cc.spriteFrameCache.addSpriteFrames(res.fly_plist,res.fly_png);
        cc.spriteFrameCache.addSpriteFrames(res.lou_plist,res.lou_png);
        cc.spriteFrameCache.addSpriteFrames(res.blow_plist,res.blow_png);
